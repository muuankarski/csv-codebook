...
<html>
    <head>
        ...
        <title>OBDX codebook yearly data</title>
    ...
    <div class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          <a href="/" class="navbar-brand">Interactive codebooks for some datasets</a>
         ...
         <div class="navbar-collapse collapse" id="navbar-main">
           <ul class="nav navbar-nav"><li class="dropdown">
              <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="themes">RLMS<span class="caret"></span></a>
              <ul class="dropdown-menu" aria-labelledby="Datasets">
          <li><a href="/rlms" title="blog">RLMS</a></li>
          </ul>   
          </ul>   

           <ul class="nav navbar-nav"><li class="dropdown">
              <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="themes">OBDX<span class="caret"></span></a>
              <ul class="dropdown-menu" aria-labelledby="Datasets">
          <li><a href="/rlms/kvartaali.html" title="blog">Kvartaali</a></li>
          <li><a href="/obdx/year_data.html" title="about">Year data</a></li> 
          </ul>   
         ...
         <ul class="nav navbar-nav navbar-right">
            <li><a title="blog RSS" href="/feed.xml"><i class="fa fa-rss fa-2x"></i></a></li>
...
```{r}
library(DT)
dat <- read.csv("/home/aurelius/data/csv-codebook/obdx/year_data.csv")
datatable(dat)
```
